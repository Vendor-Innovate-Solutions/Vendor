...
// Legacy Django API configuration (kept for backward compatibility)
// This file is being replaced by icp-auth.ts for ICP functionality
import { authStorage } from './localStorage';

const API_URL = "https://vendor-backendproduction.up.railway.app/api";

/**
 * @deprecated Use icp-auth.ts instead for ICP authentication
